    ...
    public static void fillJson(){
        try {
            List<Product> products = Arrays.asList(
                    new Product(100,"alma","Szepaghdfghlma","img/img1.jpg",1),
                    new Product(101,"alma","Szepdghdalma","img/motor2.jpg",2),
                    new Product(120,"alma","Szepdfghhdgfflma","img/motor.png",3),
                    new Product(150,"alma","Szepaldfgdgma","img/motor2.jpg",4),
                    new Product(180,"alma","Szephdfghdgfdalma","img/motor.png",5),
                    new Product(10,"alma","Szepgdalma","img/motor3.jpg",6),
