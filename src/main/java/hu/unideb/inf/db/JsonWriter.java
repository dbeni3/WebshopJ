    ...
    public static void fillJson(){
        try {
            List<Product> products = Arrays.asList(
                    ...
                    new Product(101,"motor2","Szepdghdalma","img/motor2.jpg"),
                    new Product(120,"motor3","Szepdfghhdgfflma","img/motor.png"),
                    new Product(150,"motor4","Szepaldfgdgma","img/motor2.jpg"),
                    new Product(180,"motor5","Szephdfghdgfdalma","img/motor.png"),
                    new Product(10,"motor6","Szepgdalma","img/motor3.jpg"),
